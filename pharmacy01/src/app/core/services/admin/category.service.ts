...
createcategory(category:any): Observable<any> {
 ...
 return this.http.post(`${this.myAppUrl}${this.myApiUrl}/createCategory`, uploadData)}
...
editcategory(category:any, selectedFile:any, id:any): Observable<any> {
  ...
  const uploadData = new FormData();
    ...
    uploadData.append("image", selectedFile);
      ...
      //alert ('Estoy en category service -line 45 - this.baseUrlPut+ id'+`${this.myAppUrl}${this.myApiUrl}/update-category/${id}`)
