...
import { LoginPostData } from '../../../core/interfaces/auth';
...
user:string | undefined ='';
  ...
  ngOnInit(): void { this.getThereIsAdmin();}
    ...
    this.authService.getAllAdmin().pipe(
      takeUntilDestroyed(this.destroyRef)).subscribe({
        next: ( response:any ) => {
          ...
          //alert('Iam at login.component - line 80 - HaveAdmin: ' + HaveAdmin);

          if (HaveAdmin) {
            this.haveAdmin = 'false';
            //alert('Iam at login.component - line 84 - haveAdmin: ' + this.haveAdmin);
          } else {
            
            this.haveAdmin = 'true';
            //alert('Iam at login.component - line 87 - haveAdmin: ' + this.haveAdmin);
            //alert('Error to get Admin Data:');
          }
  ...
  this.authService.login(this.form.value).pipe(
    takeUntilDestroyed(this.destroyRef)).subscribe({
      ...
      // Manejo de respuesta exitosa
        ...
        //alert ("EStoy en login() - login component - line 81: - this.mensajeBackend :" + this.mensajeBackend);
