  ...
  getDataCategories() {
    ...
    this.categoryService.getCategoryList().pipe(
      ...
      next: (response) => {
       ...
       //alert("Estoy en listCategorys-component - line 83 - this.DataCategory.Categories.name="+ this.DataCategory[0].name);

        /*** alert("Estoy en listCategorys-component - line 84 - this.DataCategory.Categorys.name="+ this.DataCategory.Categorys);*/
